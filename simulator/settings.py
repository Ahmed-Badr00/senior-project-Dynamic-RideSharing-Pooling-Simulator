...
flags.DEFINE_integer('dummy_vehicles', 1500, "number of vehicles using dummy agent")
flags.DEFINE_integer('dqn_vehicles', 6500, "number of vehicles using dqn agent")
...
flags.DEFINE_boolean('average', True, "whether to use diffusion filter or average filter")
flags.DEFINE_boolean('trip_diffusion', True, "whether to use trip diffusion")
