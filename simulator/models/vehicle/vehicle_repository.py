...
class VehicleRepository(object):
    ...
    @classmethod
    def populate(cls, vehicle_id, location, agent_type):
        state = VehicleState(vehicle_id, location, agent_type)
        print(f"Initializing vehicle {vehicle_id} with agent_type: {agent_type}")
